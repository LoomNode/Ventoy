#!/bin/sh
# Download the four toolchain/libc tarballs into ci/dl and verify SHA-256.
# Skips anything already present with the right hash.
set -eu
...
echo "fetch: all tarballs verified"
